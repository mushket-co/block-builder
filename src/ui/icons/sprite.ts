export const ICON_SYMBOLS = {
  ...
  duplicate: '<path d="M6 3h12a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z" stroke="currentColor" fill="none"/><path d="M10 3v14" stroke="currentColor"/><path d="M14 3v14" stroke="currentColor"/>',
  ...
  unlock: '<rect x="3" y="11" width="18" height="11" rx="2" ry="2" stroke="currentColor" fill="none"/><path d="M7 11V7a5 5 0 0 0 10 0" stroke="currentColor" fill="none"/>',
  ...
  eyeOff: '<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94L17.94 17.94z" stroke="currentColor" fill="none"/><path d="M1 1l22 22" stroke="currentColor"/><path d="M6.08 6.08A10.07 10.07 0 0 0 1 12s4 8 11 8a10.07 10.07 0 0 0 6-2.08" stroke="currentColor" fill="none"/><path d="M12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 3.5-4.5" stroke="currentColor" fill="none"/>',
  
  delete: '<polyline points="3 6 5 6 21 6" stroke="currentColor" fill="none"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" stroke="currentColor" fill="none"/><line x1="10" y1="11" x2="10" y2="17" stroke="currentColor"/><line x1="14" y1="11" x2="14" y2="17" stroke="currentColor"/>',

...
describe('FormBuilder', () => {
  ...
  describe('select', () => {
    ...
    test('должен сохранить выбранное значение select при редактировании блока', () => {
      const fields: TFieldConfig[] = [
        {
          field: 'textAlign',
          label: 'Выравнивание',
      ...
      const html = formBuilder.generateEditFormHTML(fields, { textAlign: 'center' });

      expect(html).toContain('name="textAlign"');

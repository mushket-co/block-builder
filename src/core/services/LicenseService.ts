import { ILicenseConfig, License, TLicenseType } from '../entities/License';
import { LicenseFeature, LicenseFeatureChecker } from './LicenseFeatureChecker';
...
export class LicenseService {
  ...
  constructor(config?: ILicenseConfig) {
    this.license = config ? License.fromConfig(config) : License.createFree(5);

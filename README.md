...
- В режиме просмотра (`isEdit: false`) все кнопки редактирования, добавления и управления блоками скрываются
- В режиме просмотра остается доступной только функция копирования ID блока
